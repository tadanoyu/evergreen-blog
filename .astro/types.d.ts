...
"dont_use_file_open_when_distributing_your_app.md": {
	id: "dont_use_file_open_when_distributing_your_app.md";
  slug: "dont_use_file_open_when_distributing_your_app";
  body: string;
  collection: "notes";
  data: InferEntrySchema<"notes">
} & { render(): Render[".md"] };
"dont_use_println_in_competitive_programming.md": {
	id: "dont_use_println_in_competitive_programming.md";
...
"implementing_a_vector_using_cpp.md": {
	id: "implementing_a_vector_using_cpp.md";
  slug: "implementing_a_vector_using_cpp";
  body: string;
  collection: "notes";
  data: InferEntrySchema<"notes">
} & { render(): Render[".md"] };
...
"rolemadelen_닉네임의_유래.md": {
	id: "rolemadelen_닉네임의_유래.md";
  slug: "rolemadelen_닉네임의_유래";
  body: string;
  collection: "notes";
  data: InferEntrySchema<"notes">
} & { render(): Render[".md"] };
...
"setting_up_cmake_for_cpp.md": {
	id: "setting_up_cmake_for_cpp.md";
  slug: "setting_up_cmake_for_cpp";
  body: string;
  collection: "notes";
  data: InferEntrySchema<"notes">
} & { render(): Render[".md"] };
...
"내가_사용한_닉네임의_기록.md": {
	id: "내가_사용한_닉네임의_기록.md";
  slug: "내가_사용한_닉네임의_기록";
  body: string;
  collection: "notes";
  data: InferEntrySchema<"notes">
} & { render(): Render[".md"] };
"바보가_되는것이_두렵다면_앞으로_나아갈_수_없다.md": {
	id: "바보가_되는것이_두렵다면_앞으로_나아갈_수_없다.md";
  slug: "바보가_되는것이_두렵다면_앞으로_나아갈_수_없다";
  body: string;
  collection: "notes";
  data: InferEntrySchema<"notes">
} & { render(): Render[".md"] };
