...
![august_dvorak](/images/19/august_dvorak.png)
...
![dvorak layout](/images/19/dvorak1.png)

단어마다 하나 이상의 모음이 거의 무조건 들어가는 영어이기에, 모음 다섯 개를 전부 홈 행(home-row) 왼쪽에 배치했다. 그리고 조합으로 자주 쓰이는 자음(consonant) 다섯 개를 오른쪽에 배치했다.

왼손의 주된 움직임과 위아래 행으로의 이동이 잦았던 기존 자판(QWERTY)과 달리, 드보락 자판은 대부분 홈 행에서 타자가 가능하다.

![dvorak layout](/images/19/dvorak2.png)
...
![dvorak layout](/images/19/heatmap_qwerty.png)


드보락 (Dvorak) 자판:

![dvorak layout](/images/19/heatmap_dvorak.png)
